...
def pento(n_trials):
    ...
    n_units = [100, 200, 240, 280, 320, 360, 420, 440]
    ...
    ind = 0
    TABLE_NAME = "powerup_mnist_1layer_finer_p1_v2"
    ...
    for i in xrange(n_trials):
        ...
        if state.powerup_nunits > 280:
            state.powerup_npieces = n_pieces[ri(low=0, high=4)]
        else:
            state.powerup_npieces = n_pieces[ri(low=2, high=(len(n_pieces) - 1))]
